  ...
  return (
    <section id="home" className="container mx-auto px-4 py-4 bg-slate-200">
      <div className="group bg-white border border-slate-200 rounded-xl p-6 hover:shadow-xl hover:border-slate-500 transition duration-300">
        ...
        <h4 className="font-display font-bold text-xl text-navy-900 mb-1 transition">
          {details.title}
        </h4>
        ...
        <Button
          className="w-full py-2 border border-slate-300 rounded font-bold text-slate-600  text-sm bg-slate-50 hover:bg-slate-200"
          onClick={() => redirectToPage(details.website)}
        >
          View Team Site
        </Button>
      </div>
